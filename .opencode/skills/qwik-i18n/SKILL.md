...
export const onRequest: RequestHandler = ({ params, locale, request }) => {
  ...
  if (!lang) {
    ...
    lang =
      config.supportedLocales.find((l) => l.lang === lang)?.lang ||
...
export const head: DocumentHead = () => {
  ...
  return {
    ...
    meta: [
      {
        name: "description",
        content: t("home.head.desc@@Description multilingue"),
      },
    ],
    links: [
...
_(Celui que tu avais, je l’ai légèrement enrichi)_
