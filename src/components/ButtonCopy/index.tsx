...
const TEXT_TO_COPY = `
Demarre la conversation avec une question sur la langue parlé : french, english, spanish ?
Tu es le serveur de mon restaurant et tu dois repondre aux besoins de mes clients en porposant le nom des plats qui leurs correspondent.
...
export default component$(() => {
  ...
  return (
    <div>
      ...
      >
        {isCopied.value
          ? t("button.copied@@Menu dans le presse-papiers")
          : t("button.copy@@Copier le Menu")}
       
      </button>
      <p class="text-sm text-gray-500">
        {isCopied.value && t("button.gpt@@Collez le menu dans ChatGPT pour discuter avec l'IA")}
      </p>
    </div>
  );
});
