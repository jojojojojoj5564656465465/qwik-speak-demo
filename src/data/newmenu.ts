...
export interface Item {
	...
	readonly allergenes?: readonly Allergie[];
	readonly src?: string;
}

export type Boisson = Omit<Item, "allergenes" | "src">;

export interface Menu {
	readonly entrees?: readonly Item[];
	readonly plats?: readonly Item[];
	readonly desserts?: readonly Item[];
	readonly boissons?: readonly Boisson[];
}
...
export const menu = {
	entrees: [
		...
		},
		{
			...
			prix: 9.0,
			allergenes: ["soja"],
			src: "/rouleaux-printemps-tofu.jpg",
		},
	...
	plats: [
		...
		},
		{
			...
			prix: 21.0,
			allergenes: ["gluten", "poisson", "lactose"],
